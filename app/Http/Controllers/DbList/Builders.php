...
trait Builders
{
    ...
    public function indexBuilder($data)
    {
        ...
        $view = function (array $data) use ($list) {
            ...
            $list
                ->addTopButton(['name' => '备份', 'value' => 'backup', 'url' => '/admin/dblist/backup', 'type' => 'checkbox'])
                ->addTopButton(['name' => '修复', 'value' => 'repair', 'url' => '/admin/dblist/repair', 'type' => 'checkbox'])
                ->addTopButton(['name' => '优化', 'value' => 'optimize', 'url' => '/admin/dblist/optimize', 'type' => 'checkbox']);
            ...
            $list
                ->addRightButton(['class' => 'btn-success', 'name' => '备份', 'value' => 'backup', 'type' => TRUE, 'url' => '/admin/dblist/backup', 'custom' => ['tableName'], 'way' => 'post'])
                #->addRightButton(['class' => 'btn-info', 'name' => '结构', 'value' => 'update', 'type' => FALSE, 'url' => '/admin/node/update', 'custom' => ['Id'], 'way' => 'get'])
                ->addRightButton(['class' => 'btn-danger', 'name' => '修复', 'value' => 'repair', 'type' => TRUE, 'url' => '/admin/dblist/repair', 'custom' => ['tableName'], 'way' => 'post'])
                ->addRightButton(['class' => 'btn-danger', 'name' => '优化', 'value' => 'optimize', 'type' => TRUE, 'url' => '/admin/dblist/optimize', 'custom' => ['tableName'], 'way' => 'post']);
    ...
    public function backupBuilder($data)
    {
        ...
        $view = function (array $data) use ($list) {
            ...
            $list
                ->addTopButton(['name' => '删除', 'value' => 'delete', 'url' => '/admin/dblist/del', 'type' => 'checkbox']);
            ...
            $list
                ->addRightButton(['class' => 'btn-success', 'name' => '删除', 'value' => 'delete', 'type' => TRUE, 'url' => '/admin/dblist/del', 'custom' => ['filename'], 'way' => 'post'])
                ->addRightButton(['class' => 'btn-info', 'name' => '下载', 'value' => 'enable', 'type' => false, 'url' => '/admin/dblist/download', 'custom' => ['name'], 'way' => 'post']);
            return $list;
