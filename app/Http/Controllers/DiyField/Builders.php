...
trait Builders
{
    public function indexBuilder($data, $page, $id)
    {
        ...
        $view = function (array $data) use ($list, $page, $id) {
            ...
            $list
                ->addTopButton(['name' => '新增', 'value' => 'create', 'url' => '/admin/diyfield/create?id=' . $id, 'type' => 'url'])
                ->addTopButton(['name' => '删除', 'value' => 'delete', 'url' => '/admin/diyfield/destroy', 'type' => 'checkbox']);
            ...
            $list
                ->addRightButton(['class' => 'btn-success', 'name' => '编辑', 'value' => 'update', 'type' => FALSE, 'url' => '/admin/diyfield/edit', 'custom' => ['Id', 'BindClass'], 'way' => 'get'])
                ->addRightButton(['class' => 'btn-primary', 'name' => '删除', 'value' => 'delete', 'type' => TRUE, 'url' => '/admin/diyfield/destroy', 'custom' => ['Id'], 'way' => 'post']);
    ...
    public function editBuilder(array $data = [], $id)
    {
        ...
        $view = function (array $data) use ($form, $id) {
            ...
            $form
                ->setSubWay('post')
                ->setFormUrl('/admin/diyfield/update');
