        ...
        public function index()
        {
            ...
            $builder
                ...
                ->addTableColumn(['name' => '栏目', 'value' => 'classId', 'type' => 'state', 'extend' => [
                    'param' => $this->infoClassModel->getInfoListClass(2)
                ]])
            ...
            $builder->page($this->infoListModel->_list(2)->links());

            $builder->addListData($this->infoListModel->_list(2)->toArray()['data']);
            ...
            $builder
                ...
                ->addRightButton(['class' => 'btn-primary', 'name' => '删除', 'value' => 'delete', 'type' => TRUE, 'url' => UrlFunc::jumpUrl('infolist/delete'), 'custom' => ['id'], 'way' => 'post']);
            ...
            if ($request->isMethod('post')) {
                ...
                $builder
                    ...
                    ->addFormItem(['name' => 'classId', 'type' => 'select', 'title' => '栏目', 'parameter' =>
                        $this->infoClassModel->getInfoListClass(2), 'extra' => 'required'
                    ])
            ...
            if ($request->isMethod('post')) {
                ...
                $builder
                    ...
                    ->addFormItem(['name' => 'classId', 'type' => 'select', 'value' => $data['classId'], 'title' => '栏目', 'parameter' =>
                        $this->infoClassModel->getInfoListClass(2)
                    ])
