...
trait Builders
{
    public function indexBuilder($data)
    {
        ...
        $view = function (array $data) use ($list) {
            ...
            $list
                ->addTopButton(['name' => '新增', 'value' => 'add', 'url' => '/admin/node/add', 'type' => 'url'])
            ...
            $list
                ->addRightButton(['class' => 'btn-success', 'name' => '编辑', 'value' => 'update', 'type' => FALSE, 'url' => '/admin/node/update', 'custom' => ['Id'], 'way' => 'get'])
