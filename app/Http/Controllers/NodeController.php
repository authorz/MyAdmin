    ...
    class NodeController extends Controller
    {
        ...
        public function update(Node $nodeModel, Request $request)
        {
            if ($request->isMethod('post')) {
                ...
                $builder
                    ->addFormItem(['name' => 'redirect', 'type' => 'hidden', 'value' => UrlFunc::jumpUrl('node')])
        ...
        public function add(Node $nodeModel, Request $request)
        {
            if ($request->isMethod('post')) {
                ...
                $builder
                    ->addFormItem(['name' => 'redirect', 'type' => 'hidden', UrlFunc::jumpUrl('node')])
                    ->addFormItem(['name' => 'Module', 'type' => 'hidden', 'value' => $_GET['Module']])
