<?php
    ...
    class RoleController extends Controller
    {
        public function index(Role $role)
        {
            ...
            $builder
                ->addTopButton(['name' => '新增', 'value' => 'add', 'url' => UrlFunc::jumpUrl('role/add'), 'type' => 'url'])
                ->addTopButton(['name' => '启用', 'value' => 'enable', 'url' => UrlFunc::jumpUrl('role/enable'), 'type' => 'checkbox'])
                ->addTopButton(['name' => '禁用', 'value' => 'disable', 'url' => UrlFunc::jumpUrl('role/disable'), 'type' => 'checkbox'])
                ->addTopButton(['name' => '删除', 'value' => 'delete', 'url' => UrlFunc::jumpUrl('role/delete'), 'type' => 'checkbox']);
            ...
            $builder
                ->addRightButton(['class' => 'btn-success', 'name' => '编辑', 'value' => 'update', 'type' => FALSE, 'url' => UrlFunc::jumpUrl('role/update'), 'custom' => ['ID'], 'way' => 'get'])
                ->addRightButton(['class' => 'btn-info', 'name' => '启用', 'value' => 'enable', 'type' => TRUE, 'url' => UrlFunc::jumpUrl('role/enable'), 'custom' => ['Id'], 'way' => 'post'])
                ->addRightButton(['class' => 'btn-danger', 'name' => '禁用', 'value' => 'disable', 'type' => TRUE, 'url' => UrlFunc::jumpUrl('role/disable'), 'custom' => ['Id'], 'way' => 'post'])
                ->addRightButton(['class' => 'btn-primary', 'name' => '删除', 'value' => 'delete', 'type' => TRUE, 'url' => UrlFunc::jumpUrl('role/delete'), 'custom' => ['Id'], 'way' => 'post']);
        ...
        public function add(Request $request)
        {
            if ($request->isMethod('post')) {
                ...
                $builder
                    ->addFormItem(['name' => 'redirect', 'type' => 'hidden', 'value' => UrlFunc::jumpUrl('role')])
