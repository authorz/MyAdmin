            ...
            if (themeColorCke) {
                if (themeColorCke === 'default') {
                    ...
                    if (themeLink.length) {
                        ...
                        $('link[href="/asstes/css/themes.css"]')
                            .before('<link id="theme-link" rel="stylesheet" href="/asstes/' + themeColorCke + '">');
        ...
        $('a', colorList).click(function(e){
            ...
            if (themeColor === 'default') {
                ...
                if (themeLink.length) {
                    ...
                    themeLink.attr('href', '/asstes/'+themeColor);
                } else {

                    $('link[href="/asstes/css/themes.css"]')
                        .before('<link id="theme-link" rel="stylesheet" href="/asstes/' + themeColor + '">');
